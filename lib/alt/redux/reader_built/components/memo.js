...
var Memo = (function (_super) {
    ...
    Memo.prototype.writeTagList = function () {
        return this.props.memo.tags.map(function (tagData) {
            return React.createElement("li", {"className": "memo tag", "key": 'memoTag' + tagData.id}, React.createElement(fa_1.default, {"icon": "tag"}), React.createElement("a", {"onClick": function () { return mixins_1.TagWork.index([tagData.id]); }}, tagData.name));
        });
    };
