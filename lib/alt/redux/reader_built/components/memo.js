...
var Memo = (function (_super) {
    ...
    Memo.prototype.componentDidUpdate = function () {
        var app = this.props.works.app;
        if (this.props.memo.html === '') {
            var portal = app.getPortal();
    ...
    Memo.prototype.writeTagList = function () {
        ...
        return this.props.memo.tags.map(function (tagData) {
            return React.createElement("li", {"className": "memo tag", "key": 'memoTag' + tagData.id}, React.createElement(fa_1.default, {"icon": "tag"}), _this.props.works.app.createTagLink(tagData.id, tagData.name));
        });
    };
