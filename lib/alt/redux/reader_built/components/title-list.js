...
var TitleList = (function (_super) {
    ...
    TitleList.prototype.writeTitleList = function () {
        var _this = this;
        var _a = this.props, titles = _a.titles, works = _a.works;
        return titles.map(function (memo) {
            return React.createElement("li", {"key": 'memo' + memo.id, "className": _this.detectActiveClass(memo.id)}, React.createElement("div", {"className": "chevron"}, _this.detectIcon(memo.id)), React.createElement("a", {"onClick": function () { return works.memo.show(memo.id); }}, memo.title));
        });
    };
