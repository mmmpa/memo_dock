...
var TitleList = (function (_super) {
    ...
    TitleList.prototype.writeTitleList = function () {
        ...
        return titles.map(function (memo) {
            return React.createElement("li", {"key": 'memo' + memo.id, "className": _this.detectActiveClass(memo.id)}, React.createElement("a", {"onClick": function () { return console.log(memo.id); }}, memo.title));
        });
    };
    TitleList.prototype.render = function () {
        var height = this.props.height;
        return React.createElement("section", {"id": "titleList", "style": { height: height }, "className": "title-list title-list-container"}, React.createElement("ul", {"className": "title-list list"}, this.writeTitleList()));
    };
    return TitleList;
})(React.Component);
