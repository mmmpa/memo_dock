...
var TitleList = (function (_super) {
    ...
    TitleList.prototype.writeTitleList = function () {
        ...
        return titles.map(function (memo) {
            return React.createElement("li", {"key": 'memo' + memo.id, "className": _this.detectActiveClass(memo.id)}, React.createElement("div", {"className": "chevron"}, _this.detectIcon(memo.id)), works.app.createMemoLink(memo.id, memo.title));
        });
    };
