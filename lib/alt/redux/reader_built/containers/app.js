...
var App = (function (_super) {
    ...
    App.prototype.selectTag = function (tagIdNumbers) {
        if (tagIdNumbers.length) {
            ...
            var path = path_manip_1.pickPath() + path_manip_1.buildQueryString({ tagIds: tagIds });
            console.log(this.props.pushState, path, path_manip_1.pickPath(), path_manip_1.buildQueryString({ tagIds: tagIds }));
    ...
    App.prototype.render = function () {
        ...
        return React.createElement("article", {"className": "reader-container"}, React.createElement("section", {"id": "selectorContainer", "className": "selector-container", "style": { height: windowHeight }}, React.createElement("div", {"className": "wrapper"}, React.createElement(tag_list_1.default, {"works": works, "tags": tags, "tagState": tagState, "selectedTagIds": selectedTagIds, "height": windowHeight}), React.createElement(title_list_1.default, {"works": works, "titles": titles, "memo": memo, "memoState": memoState, "height": windowHeight}))), React.createElement(memo_1.default, {"works": works, "memo": memo, "memoState": memoState, "height": windowHeight, "width": memoWidth}));
    };
    return App;
})(React.Component);
