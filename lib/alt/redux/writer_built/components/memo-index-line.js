...
var MemoIndexLine = (function (_super) {
    ...
    MemoIndexLine.prototype.tagLinks = function (tags) {
        ...
        return tags.map(function (tagData) { return React.createElement(memo_index_tag_link_1.default, {"key": tagData.id, "tagData": tagData, "works": works}); });
    };
    ...
    MemoIndexLine.prototype.render = function () {
        ...
        return React.createElement("tr", null, React.createElement("td", {"className": "title"}, React.createElement("a", {"className": this.detectLinkEnabled(), "onClick": function () { return works.memo.editMemoById(memoData.id); }}, memoData.title)), React.createElement("td", {"className": "tags"}, this.tagLinks(memoData.tags)), React.createElement("td", {"className": "public"}, this.detectPublicText()), React.createElement("td", {"className": "delete"}, React.createElement("button", {"disabled": !this.isEnable(), "onClick": function () { return works.memo.deleteMemo(memoData); }}, React.createElement(fa_1.default, {"icon": "trash-o"}))));
    };
