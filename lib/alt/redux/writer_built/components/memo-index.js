...
var MemoIndex = (function (_super) {
    ...
    MemoIndex.prototype.memoLines = function () {
        ...
        return memos.map(function (memoData) { return React.createElement(memo_index_line_1.default, {"key": memoData.id, "memoData": memoData, "works": works}); });
    };
