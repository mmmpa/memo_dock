...
var MemoIndex = (function (_super) {
    ...
    MemoIndex.prototype.memoLines = function () {
        ...
        var memoIndexState = this.props.memoIndexState;
        var isEnable = this.isEnable;
        return memos.map(function (memoData) { return React.createElement(memo_index_line_1.default, React.__spread({"key": memoData.id}, { memoData: memoData, isEnable: isEnable })); });
    };
