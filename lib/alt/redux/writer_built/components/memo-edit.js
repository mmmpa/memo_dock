...
var MemoEdit = (function (_super) {
    ...
    function MemoEdit(props) {
        ...
        if (this.props.memoData) {
            var _a = this.props.memoData, title = _a.title, src = _a.src, isPublic = _a.isPublic, tagList = _a.tagList;
            this.state = {
                title: title,
                src: src,
                isPublic: isPublic,
    ...
    MemoEdit.prototype.componentDidMount = function () {
        var _this = this;
        setTimeout(function () {
            _this.cm = CodeMirror.fromTextArea($('#editor')[0], {
                lineNumbers: true,
                mode: "slim",
                lineWrapping: true
            });
    ...
    MemoEdit.prototype.render = function () {
        var _a = this.state, title = _a.title, src = _a.src, tagList = _a.tagList, isPublic = _a.isPublic;
