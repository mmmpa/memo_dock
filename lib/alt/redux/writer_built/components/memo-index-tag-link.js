...
var MemoIndexTagLink = (function (_super) {
    ...
    MemoIndexTagLink.prototype.render = function () {
        var _a = this.props, tagData = _a.tagData, works = _a.works;
        return (React.createElement("div", {"className": "memo-index tag-link-container"}, React.createElement("a", {"className": this.detectLinkEnabled(), "onClick": function () { return works.memo.loadTaggedIndex(tagData); }}, tagData.name)));
    };
