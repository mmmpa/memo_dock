...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        // injected by connect
        var _a = this.props, dispatch = _a.dispatch, loggedIn = _a.loggedIn, loginState = _a.loginState, context = _a.context;
        if (!this.initialized) {
            this.initialized = true;
            dispatch(login_2.checkInitialState(function () { return router.goHere(); }));
